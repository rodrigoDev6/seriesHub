        ...
        <div class="mx-auto md:max-w-2xl sm:px-6 lg:px-8">
            ...
            <div class="flex-col px-4 py-6">
                <form action="{{ route('series.update', $series->id) }}" method="post">
                    ...
                    <div class="flex mb-2 gap-2">
                        <label class="w-10/12">
                            ...
                            <input type="date" name="release_date" value="{{ $series->release_date }}"
                                    class="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                            focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
                            invalid:border-pink-500 invalid:text-pink-600
                            focus:invalid:border-pink-500 focus:invalid:ring-pink-500
                    ...
                    <div class="flex mb-3">
                        <label class="w-full">
                            ...
                            <textarea name="series_description" rows="4" value="teste"
                ...
                <form action="{{route('series.destroy', $series->id)}}" method="post">
                        ...
                        @method('DELETE')
                        <button type="submit"
                        class="bg-red-500 hover:bg-red-700 px-5 py-2.5 text-sm leading-5 rounded-md font-semibold text-white">
                        Excluir
                        </button>
                </form>
                </div>
